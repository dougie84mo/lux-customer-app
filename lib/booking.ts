...
// importers of these from '@/lib/booking' keep working.
export { depositAmountCents, depositAppliesAtBooking } from './bookingLogic';
export type { DepositTiming, DepositType } from './bookingLogic';
